...
Listen carefully to the user's response. Acknowledge what they say professionally. Do NOT over-praise or use flowery language (e.g., avoid "phenomenal", "perfect", "super"). Maintain the stance that their resume requires our strategic optimization to bring those traits to the surface.
</instruction>
